...
public class AdminTest {
	...
	// email && pass
	public void adminLogin(String useremail, String pass) throws SQLException {
		// boolean result = admindao.searchAdmin(useremail, pass);
		User user = admindao.searchAdmin(useremail, pass);
